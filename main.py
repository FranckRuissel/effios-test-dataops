...
"""
=========================================================
MAIN SCRIPT - Test Pratique DataOps EFFIOS
=========================================================
Auteur : [Ton Nom/Prénom] - Étudiant M2 Data
Objectif : Analyse des données d'audience DNMA
=========================================================
"""
...
def main():
    # 1. Chargement des variables d'environnement (API_KEY)
    # Très important pour ne pas laisser traîner de secrets sur GitHub
    load_dotenv()
    
    logger.info("Démarrage du programme d'analyse DNMA...")

    # 2. Récupération des données (Logique hybride API / Local gérée dans le module)
    df = load_dnma_data()
    ...
    # 3. Initialisation de la classe d'analyse
    # On passe le DataFrame une seule fois pour optimiser les performances
    ...
    # --- EB2 : Agrégation par UAI et Granularité ---
    # Exemple avec l'UAI cible et une granularité par mois
    ...
    # --- EB4 : Fonctionnalité libre (Mobilité par Académie) ---
